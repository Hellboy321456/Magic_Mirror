...
app.get("/standby.flag", function (req, res) {
	const flagPath = path.resolve(__dirname, "..", "standby.flag");
	res.sendFile(flagPath, function (err) {
		if (err) {
...
// ✅ Serve standby.flag from the root
app.get("/standby.flag", function (req, res) {
	const flagPath = path.resolve(__dirname, "..", "standby.flag");
	res.sendFile(flagPath, function (err) {
		if (err) {
